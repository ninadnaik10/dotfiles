...
# mailcount.sh {
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILDIR_INBOX="/home/ninad/.mail/inbox/new"
	
	## mbox
	# Path to the mbox to check.
	export TMUX_POWERLINE_SEG_MAILCOUNT_MBOX_INBOX="/var/spool/mail/ninad"
	
	## mailcheck
	# Optional path to mailcheckrc
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILCHECKRC="/home/ninad/.mailcheckrc"
# }
...
# now_playing.sh {
	...
	# export TMUX_POWERLINE_SEG_NOW_PLAYING_TRACK_LOG_FILEPATH="/home/ninad/.now_playing.log"
...
# weather.sh {
	...
	TMUX_POWERLINE_SEG_WEATHER_LAT="19.076"
	TMUX_POWERLINE_SEG_WEATHER_LON="72.877"
# }
